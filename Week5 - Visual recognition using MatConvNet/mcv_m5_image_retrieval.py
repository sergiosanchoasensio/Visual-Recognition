...
if __name__ == "__main__":
    ...
    parser.add_argument('-pqm',        dest='pqm',        default=20,           required=False, type=int,  help='pqm')
    parser.add_argument('-lsh',        dest='lsh',                          action='store_true',       help='LSH')
    parser.add_argument('-invfile',    dest='invfile',                      action='store_true',       help='Inverted list')
    parser.add_argument('-global',     dest='global_des', default='vlad',                              help='Global descriptor: bow|vlad|fisher vector')
    parser.add_argument('-getglobal',  dest='getglobal',                    action='store_true',       help='Compute global descriptor on train images')
    ...
    # query files
    QUERYFILES = tl.getFilelist(QueryDir+'dog/','jpg')[0] + \
                 tl.getFilelist(QueryDir+'car/','jpg')[0]
    ...
    if not query:
        ...
        if compute_global and bow:
            print('compute BOW')
            bw.computeBoW(LIBFILES,params,runmultiprocess,bowDir,showFig)
        ...
        print 'performance 15: %2.2f ' % mean_aver15
        print 'performance 20: %2.2f ' % mean_aver20
