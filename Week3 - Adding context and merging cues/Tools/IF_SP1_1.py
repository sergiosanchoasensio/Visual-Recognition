...
doPCA               = False
pca_components      = 16
weighting           = 0.5 # Valor entre 0 y 1. Representa la importancia del primer descriptor respecto el segundo (solo se aplica si len(descriptors) == 2). Por defecto usar 0.5.
colormode           = 1 # Tipo de color para el descriptor.
